...
plotFreqByYearAndMagnitude <- function(mag, year) { barplot(countByYear(mag,year), names.arg = 1900:year)}

plotAbsMagByYearAndMagnitude <- function(mag, year) { barplot(magByYear(mag,year), names.arg = 1900:year)}
